            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form action="{{ route('auth.postForm') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" value="0" hidden  name="role"  id="form3Example3"
                                class="form-control form-control-lg" />
                        </div>
                        <div class="form-outline mb-4">
                            <input type="file" name="avatar" id="form3Example3"
                                class="form-control form-control-lg" />
                            <label class="form-label" for="form3Example3">Ảnh đại diện</label>
                        </div>
                        <div class="form-outline mb-4">
                            <input type="text" name="username" id="form3Example3" class="form-control form-control-lg"
                                placeholder="Tên hiểnt thị" />
                            <label class="form-label" for="form3Example3">Tên hiển thị</label>
                        </div>
                        <div class="form-outline mb-4">
                            <input type="text" value="0" name="status" hidden id="form3Example3" class="form-control form-control-lg"
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="form-check mb-0">
                                <input hidden class="form-check-input me-2" type="checkbox" value=""
                                    id="form2Example3" />
                                <label hidden class="form-check-label" for="form2Example3">
                                    Remember me
                                </label>
                            </div>
                            <a hidden href="#!" class="text-body">Forgot password?</a>
                        </div>

                        <div class="text-center text-lg-start mt-4 pt-2">
                            <button  class="btn btn-primary btn-lg"
                                style="padding-left: 2.5rem; padding-right: 2.5rem;">Register</button>
                            <p class="small fw-bold mt-2 pt-1 mb-0">Do you have an account available? <a
                                    href="{{ route('auth.getLogin') }}" class="link-danger">Login</a></p>
                        </div>
